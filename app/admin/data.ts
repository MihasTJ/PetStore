...
export const PRODUCTS: Product[] = [
  { id: "p-001", name: "Suplement na stawy z glukozaminą — premium", slug: "suplement-stawy-premium", original: "GlucoVet Joint 60kaps - WHOLESALER SKU 88421", supplier: "Droplo / VetPharma PL", price: 189, price_promo: null, stock: 47, status: "Active", is_premium_verified: true, vet: "dr Anna Kowalska", category: "Suplementy", category_id: null, species: "Pies", health: ["Stawy", "Senior"], life_stage: ["Dorosły", "Senior"], breed_tags: ["Golden Retriever", "Labrador"], updated: "2 godz temu", img: "Suplement\nstawy" },
  { id: "p-002", name: "Karma sucha — łosoś norweski dla seniora", slug: "karma-losos-norweski-senior", original: "Salmon Senior Dog Food 4kg PREMIUM", supplier: "BaseLinker / NordicPet", price: 249, price_promo: null, stock: 12, status: "Active", is_premium_verified: true, vet: "dr Piotr Mazur", category: "Karma", category_id: null, species: "Pies", health: ["Sierść", "Stawy"], life_stage: ["Senior"], breed_tags: [], updated: "Wczoraj", img: "Karma\nłosoś" },
  { id: "p-003", name: "Probiotyk dla kota z wrażliwym żołądkiem", slug: "probiotyk-kot-wrazliwy-zoladek", original: "FelineGut Probiotic 30 sachets", supplier: "Droplo / FelineCare", price: 129, price_promo: null, stock: 0, status: "Out of stock", is_premium_verified: true, vet: "dr Anna Kowalska", category: "Suplementy", category_id: null, species: "Kot", health: ["Układ pokarmowy"], life_stage: ["Dorosły"], breed_tags: [], updated: "3 dni temu", img: "Probiotyk" },
  { id: "p-004", name: "Akcesorium stomatologiczne — szczotka silikonowa", slug: "szczotka-stomatologiczna-silikon", original: "DentalCare Silicone Brush ECO", supplier: "BaseLinker / PetEssentials", price: 39, price_promo: null, stock: 124, status: "Active", is_premium_verified: false, vet: null, category: "Akcesoria", category_id: null, species: "Pies/Kot", health: ["Zęby"], life_stage: [], breed_tags: [], updated: "5 dni temu", img: "Szczotka" },
  { id: "p-005", name: "Karma mokra — kurczak z warzywami (kot)", slug: "karma-mokra-kurczak-warzywa-kot", original: "WetCat Chicken+Veggies 12x85g", supplier: "Droplo / FelineCare", price: 89, price_promo: null, stock: 4, status: "Active", is_premium_verified: true, vet: "dr Anna Kowalska", category: "Karma", category_id: null, species: "Kot", health: ["Waga"], life_stage: ["Dorosły", "Kocię"], breed_tags: [], updated: "Dziś", img: "Karma\nmokra" },
];
